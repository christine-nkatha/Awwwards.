# Generated by Django 4.0.5 on 2022-06-15 07:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='awwwardapp.profile')),
            ],
        ),
        migrations.CreateModel(
            name='Ratings',
            fields=[
                ...
                ('projects', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratings', to='awwwardapp.projects')),
                ('rater', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='awwwardapp.profile')),
            ],
            options={
                'ordering': ['-pub_date'],
            },
